...
MediaDisplay stores the differnt display options for a MediaType.
...
Foreign key constraint on L<Interchange6::Schema::Result::MediaType/media_types_id>
...
Examples C<image_120x120>, C<image_200x200>.  Is nullable.
...
It's used by the Product class to create the uri for each display. Is nullable.
...
Examples C<120x120>, C<200x200>.  Is nullable.
